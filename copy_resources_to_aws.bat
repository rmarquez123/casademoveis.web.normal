...
set REMOTE_PATH=/deployments/terrabyte/build/usedfurniture/usedfurniture.web/
set LOCAL_FILE_PATH=C:\Dev\personal\usedfurniture.web\usedfurniture.web
set TEMP_DIR=C:\Temp\usedfurniture_transfer\usedfurniture.web
